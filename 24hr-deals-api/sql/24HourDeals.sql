...
Insert into user (FirstName, LastName, Email, Password, dateCreated) values ('Robert', 'Basson', 'Rob123@Bass.co.za', 'whatabc', '1998-07-21');
...
insert into Product (ProductName, ProductDescription, StockQuantity, Price, CategoryId) values ('Headset','Electronic device for relaying sound to your ears only','10','500', 1);
insert into Product (ProductName, ProductDescription, StockQuantity, Price, CategoryId) values ('Microwave','It warms things up pretty well','15','1200', 2);
insert into Product (ProductName, ProductDescription, StockQuantity, Price, CategoryId) values ('Hat','Appropriate for holidays and drinking','20','200', 3);
insert into Product (ProductName, ProductDescription, StockQuantity, Price, CategoryId) values ('PS4','Basically an Xbox','10','6000', 4);
insert into Product (ProductName, ProductDescription, StockQuantity, Price, CategoryId) values ('Xbox 1','A Cheaper PS4, only just','10','5500', 4);
